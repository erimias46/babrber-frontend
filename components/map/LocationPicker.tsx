...
export function LocationPicker({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-2 sm:p-4 overflow-y-auto">
      <div className="w-full h-full sm:h-auto flex items-center justify-center py-4 sm:py-0">
        <Card className="w-full max-w-4xl sm:max-h-[90vh] overflow-hidden flex flex-col">
          <div className="p-3 sm:p-6 flex flex-col h-full sm:h-auto overflow-hidden">
            {/* Header */}
            ...
            <div className="flex flex-col-reverse sm:flex-row justify-end space-y-2 space-y-reverse sm:space-y-0 sm:space-x-3 pt-4 border-t sm:border-t-0 flex-shrink-0">
              {onCancel && (
                <Button 
                  variant="secondary" 
                  onClick={onCancel}
